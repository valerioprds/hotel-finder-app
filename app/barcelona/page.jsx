            ...
            .then((data) => {
                ...
                return Promise.all(
                    barcelonaHotels.map((hotel) => {
                        ...
                        .then((response) => response.json())
                        .then((hotelDetails) => {
                            // Assuming 'photos' is a string of URLs separated by commas
                            hotelDetails.photos = hotelDetails.photos.split(',')[0];
                    ...
                    {hotels.map((hotel, index) => (
                        ...
                        >
                            <div className="relative h-64 md:h-auto md:w-1/5">
                                <Image
                                    src={hotel.photos} // First photo URL
                                    layout="fixed"
                                    width={300}
                                    height={150}
                                    alt={hotel.name}
                            ...
                            <div className="flex flex-col justify-between p-4 leading-normal">
                                <div>
                                    ...
                                    <p className={`${styles.customFontSize} text-gray-700 text-sm`}>
