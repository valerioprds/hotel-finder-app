...
import styles from "./MadridComponent.module.css";
...
export default function HotelsList() {
	...
	useEffect(() => {
		fetch("http://api.egruppa.com/accommodations/search")
			...
			.then((data) => {
				const madridHotels = data.accommodations.filter(
					(hotel) => hotel.location === "MADRID"
				);
				return Promise.all(
	...
	return (
		<div className={`bg-gray-100 p-4 ${styles.container}`}>
			<div className="container mx-auto">
				<h2 className="font-bold text-2xl mb-4">Hotels in Madrid</h2>
